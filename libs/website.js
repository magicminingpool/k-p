...
var util = require('../stratum/util.js');
...
module.exports = function (portalsConfig, poolConfig) {
	logger.info("Starting Website module");
	dot.templateSettings.strip = false;

	var portalConfig = JSON.parse(portalsConfig);
	var poolConfigs = JSON.parse(poolConfig);
